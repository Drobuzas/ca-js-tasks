...
let nouns = ['apple', 'sister', 'hammer', 'sun', 'table', 'sky', 'lake', 'table', 'hits', 'nail', 'pocket' ];
...
let sentence2 = nouns [2] + helpers[7] + helpers [4] + helpers[7] + helpers[2] + helpers[7] + helpers[6] + helpers[7] + nouns[5];
...
// 6. hammer hits the nail
let sentence5 = nouns[2] + helpers[7] +  nouns[8] + helpers[7] + helpers[7] + helpers[6] + helpers[7] + nouns[9];
console.log(sentence5)
// 7. nail is in my pocket
let sentence6 = nouns[9] + helpers[7] + helpers[4] + helpers[7] + helpers[0] + helpers[7] + helpers[3] + helpers[7] + nouns[10];
console.log(sentence6)
// 8. my hammer is on the table
let sentence7 = helpers[3] + helpers[7] + nouns[2] + helpers[7] + helpers[4] + helpers[7] + helpers[2] + helpers[7] + helpers[6] + helpers[7] + nouns[7];
